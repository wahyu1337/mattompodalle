        ...
        <footer class="footer">
            <div class="container">
                <div class="footer__grid">
                    ...
                    <div class="footer__brand">
                        <div class="footer__logo-group">
                            ...
                            <div>
                                ...
                                <span class="footer__brand-subtitle">Kec. Polongbangkeng Utara, Kab. Takalar</span>
                            </div>
                        </div>
                        <p class="footer__brand-desc">
                            Portal informasi dan pelayanan publik resmi Kelurahan Mattompodalle. Mewujudkan pelayanan prima, transparan, dan inklusif bagi seluruh warga.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="footer__links">
                            ...
                            <li><a href="/informasi/" class="footer__link">Informasi &amp; Layanan</a></li>
                            <li><a href="/gallery/" class="footer__link">Galeri Kegiatan</a></li>
                            <li><a href="/kontak/" class="footer__link">Kontak &amp; Lokasi</a></li>
                        </ul>
                    </div>

                    <!-- Contact & Office Info -->
                    <div>
                        <h4 class="footer__column-title">Kontak &amp; Kantor</h4>
                        <div class="footer__contacts">
                            <div class="footer__contact-item">
                                ...
                                <span>Jl. Poros Mattompodalle, Kec. Polut, Kab. Takalar 92221</span>
                            </div>
                            <div class="footer__contact-item">
                                <svg class="footer__contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                                </svg>
                                <span>0852-4029-1397 (Lurah)</span>
                            </div>
                            <div class="footer__contact-item">
                                <svg class="footer__contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="footer__bottom">
                    ...
                    <p>Kabupaten Takalar, Sulawesi Selatan</p>
                </div>
            </div>
        </footer>
    `;
